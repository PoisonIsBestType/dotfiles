...
local utils = require("widget.todo.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("widget.todo.volume-widget.widgets.icon-and-text-widget"),
    icon = require("widget.todo.volume-widget.widgets.icon-widget"),
    arc = require("widget.todo.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("widget.todo.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("widget.todo.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
