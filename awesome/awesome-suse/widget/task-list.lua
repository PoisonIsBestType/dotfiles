...
local function list_update(w, buttons, label, data, objects)
  ...
  for i, o in ipairs(objects) do
    ...
    if cache then
      ...
      cb =
        ...
        wibox.container.margin(
          wibox.widget.imagebox(os.getenv('HOME') .. '/.config/awesome/theme/icons/tag-list/close.png'),
          0,
          0,
          6,
          6
      ...
      cbm = wibox.container.margin(cb, 0, 0, 2, 2)
      cbm:buttons(
        gears.table.join(
          awful.button(
            {},
      ...
      ibm = wibox.container.margin(ib, 0, 0, 8, 8)
    ...
    if text == nil or text == '' then
      ...
      if (textOnly:len() > 13) then
        text = text:gsub('>(.-)<', '>' .. textOnly:sub(1, 10) .. '...<')
