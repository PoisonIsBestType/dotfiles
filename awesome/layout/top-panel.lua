...
local net_speed_widget = require('widget.todo.net-speed-widget.net-speed')
local calendar_widget = require('widget.todo.calendar-widget.calendar')
local volume_widget = require('widget.todo.volume-widget.volume')
local apt_widget = require('widget.todo.apt-widget.apt-widget')
local spotify_widget = require('widget.todo.spotify-widget.spotify')
