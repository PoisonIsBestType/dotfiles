...
-- https://github.com/streetturtle/widget.todo/tree/master/spotify-widget
...
local function worker(user_args)
    ...
    local play_icon = args.play_icon or '/home/almeida/.config/awesome/widget/todo/spotify-widget/play.png'
    local pause_icon = args.pause_icon or '/home/almeida/.config/awesome/widget/todo/spotify-widget/pause.png'
