...
-- "AWSDZXC" Tag Control
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[1]
        if tag then
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[2]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[3]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[4]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[5]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[6]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
  ...
  awful.key(
    ...
    function()
      if _G.client.focus then
        local tag = _G.client.focus.screen.tags[7]
        if tag then
          _G.client.focus:move_to_tag(tag)
        end
      end
